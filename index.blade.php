...
<section class="hero-section" style="background-image: url('{{$data->bannerImage}}')">
    ...
    <!-- Preserve the original search bar with dynamic data -->
            ...
            <div class="col-lg-4 col-md-6 mb-4">
                <div class="property-card">
                    ...
                    <div class="property-content">
                        <h3 class="property-title"><a href="{{url($c->seo_url)}}">{{$c->title}}</a></h3>
...
<section class="attraction-section">
    <div class="container">
        ...
        <div class="text-center mt-3 mt-md-4">
            <a href="{{ url('attractions') }}" class="btn btn-outline-secondary py-2 py-md-3 px-3 px-md-4">
...
/* Search button */
.search-btn {
    background: #1A56DB; /* Blue color for the search button */
    color: white;
    border: none;
    height: 50px;
    border-radius: 100px;
