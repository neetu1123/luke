    ...
    border-radius: 10px;">
                    ...
                    <div class="content-sections ">
                        <div class="row hosted">
                            <div class="col-lg-11">
                                <h4 class="fw-bold textColor mt-3">{{$data->title}}</h4>
                ...
                <div class="col-lg-4" id="book">
                    <div class="get-quote">
                        <div class="forms-booking-tab">
                            <ul class="tabs">
                                <li class="item booking active text-black" data-form="ovabrw_booking_form">Enter your dates and experience the charm</li>
                            </ul>
